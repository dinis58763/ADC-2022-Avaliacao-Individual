...
@WebServlet("/gbomenu" // "/delete"
)

@Path("/login")
@Produces(MediaType.APPLICATION_JSON + ";charset=utf-8")

public class roleGBOResource extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			if (roleUser.equals("user") || roleUser.equals("gbo")) {
				...
				if(roleUser.equals(role))
					roleUp = roleUser; // can't update role
				else
